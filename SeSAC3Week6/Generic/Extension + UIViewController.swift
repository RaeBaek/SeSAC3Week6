...
extension UIViewController {
    ...
    enum TransitionStyle {
        ...
        case presentFullNavigation // 네비게이션 일베드 된 fullscreen present
        case push
    }
    ...
    func transition<T: UIViewController>(viewController: T.Type, storyboad: String, style: TransitionStyle) {
        let sb = UIStoryboard(name: storyboad, bundle: nil)
